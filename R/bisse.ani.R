bisse.ani <-
function(q0=0.0,q1=0.555,b0=5.199,b1=2.933,d0=5.433,d1=2.319,starting0=0,starting1=1,colorVector=c(rgb(0,1,.2,0.9),rgb(0.3,0,1,0.7),rgb(0,1,.2,0.2),rgb(0.3,0,1,0.2)),radius=0.1,drawtomutatecount=2,allowExtinction=FALSE,subsampleAt=100) {
